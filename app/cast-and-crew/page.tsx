...
import { client, queries, CastMember, CrewMember } from "@/lib/sanity";
...
function getFallbackCrewMembers(): CrewMember[] {
  return [
    {
      _id: "temp-crew-1",
      name: "Matthew Gasda",
...
export default async function CastAndCrew() {
  ...
  return (
    ...
    >
      <CastGrid castMembers={castMembers} crewMembers={crewMembers} />
    </MainLayout>
  );
}
